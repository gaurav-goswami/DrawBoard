...
import {PiGithubLogo, PiTwitterLogo, PiLinkedinLogoLight} from "react-icons/pi";
  ...
  return (
    <>
      <aside className="w-[14rem] bg-[#1e1e1e] absolute top-[85%] left-2 rounded-md py-4 px-2 flex flex-col gap-2 z-20">
        ...
        <div className="h-[1px] bg-[#4a4a4a] my-1"/>
        <button className="text-gray-400 list-none inline-flex items-center justify-start gap-2 font-assistant cursor-pointer hover:bg-[#2b2e31ce] px-2 py-1.5 rounded-lg"><BsSunFill className = "text-sm"/> Light mode</button>
      </aside>
    </>
  );
};
